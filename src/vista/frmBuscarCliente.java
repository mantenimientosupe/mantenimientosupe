...
public class frmBuscarCliente extends javax.swing.JDialog {
    ...
    public frmBuscarCliente(java.awt.Frame parent, boolean modal, sesion pSesion, JInternalFrame frmOrigen) {
        ...
        oSesion = pSesion;
         if (frmOrigen instanceof Servicios) {
            this.oFrmVenta = (Servicios) frmOrigen; // sólo si es realmente Servicioss
          }
        //oFrmVenta = frmOrigen;
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        oFrmVenta.txtIdCliente.setText(codigo);
        oFrmVenta.txtNombreCliente.setText(razon_social);
        oFrmVenta.toFront();
