...
public class frmBuscarProducto extends javax.swing.JDialog {
    ...
    public frmBuscarProducto(java.awt.Frame parent, boolean modal) {
     ...
     public frmBuscarProducto(java.awt.Frame parent, boolean modal, sesion pSesion, Servicios pFrmOrigen) {
        super(parent, modal);
        initComponents();
        oSesion = pSesion;
    ...
    public void cargarTabla(){
        ...
        if(opcion.equals("CODIGO")){
            ...
            condicion = " where barra like '%" + texto +"%'";
        }
        grilla.setModel(oAbmProducto.cargarTablaSeleccion(condicion));
