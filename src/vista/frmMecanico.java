...
public class frmMecanico extends javax.swing.JInternalFrame {
    sesion oSesion;
    modeloMecanico oModeloMecanico = new modeloMecanico();
    ...
    public frmMecanico() {
     ...
     public frmMecanico(sesion pSesion) {
        initComponents();
        oSesion = pSesion;
        oModeloMecanico = new modeloMecanico();
        oAbmMecanico = new abmMecanico(pSesion);
        grilla.setModel(oAbmMecanico.cargarTabla(""));
    ...
    private void initComponents() {
        ...
        btnReporteMecanico = new javax.swing.JButton();
        ...
        btnReporteMecanico.setText("Imprimir Mecanicos");
        btnReporteMecanico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnReporteMecanicoActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(btnReporteMecanico)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnReporteMecanico, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setText("REGISTRO DE MECANICO");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        oModeloMecanico = new modeloMecanico();
        oModeloMecanico.setId(Integer.parseInt(codigo));
        
        boolean resultado = oAbmMecanico.cargarRegistro(oModeloMecanico);
        if(resultado == true){
            txtCodigo.setText(String.valueOf(oModeloMecanico.getId()));
            txtNombre.setText(oModeloMecanico.getnombre());
            txtRuc.setText(oModeloMecanico.getDocumento_nro());
            txtTelefono.setText(oModeloMecanico.getTelefono());
            txtDireccion.setText(oModeloMecanico.getDireccion());
            txtEstado.setText(String.valueOf(oModeloMecanico.getEstado()));
        }                
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        grilla.setModel(oAbmMecanico.cargarTabla(condicion));
        txtBuscar.setText("");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        boolean resultado = oAbmMecanico.eliminarRegistro(oModeloMecanico);
        if(resultado == true){
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        oModeloMecanico = new modeloMecanico();
        oModeloMecanico.setId(Integer.parseInt(txtCodigo.getText()));
        oModeloMecanico.setnombre(txtNombre.getText());
        oModeloMecanico.setDocumento_nro(txtRuc.getText());
        oModeloMecanico.setTelefono(txtTelefono.getText());
        oModeloMecanico.setDireccion(txtDireccion.getText());
        oModeloMecanico.setEstado(Integer.parseInt(txtEstado.getText()));
        
        boolean resultado;
                 
        if(operacion.equals("NUEVO")){
           resultado = oAbmMecanico.insertarRegistro(oModeloMecanico);
           if(resultado == true){
               JOptionPane.showMessageDialog(null, "Registro Insertado");
           }
       }else if(operacion.equals("MODIFICAR")){
            resultado = oAbmMecanico.actualizarRegistro(oModeloMecanico);
            if(resultado==true){
    ...
    private void btnReporteMecanicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteMecanicoActionPerformed
        try {
            ...
            String ruta = "src/reportes/rptMecanico.jasper";
            //Cargar y rellenar el reporte
            JasperPrint reporteMecanico = JasperFillManager.fillReport(ruta, null, conec);

            // Mostrar el reporte en pantalla
            JasperViewer.viewReport(reporteMecanico, false);
            conec.close();
        } catch (Exception e) {
            e.printStackTrace();

        }
    }//GEN-LAST:event_btnReporteMecanicoActionPerformed
    ...
    private javax.swing.JButton btnReporteMecanico;
