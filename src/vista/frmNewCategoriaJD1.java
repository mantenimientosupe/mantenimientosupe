...
public class frmNewCategoriaJD1 extends javax.swing.JDialog {
    sesion oSesion;
    frmVehiculos oFrmVehiculo;
    abmCategoria oAbmCategoria;
    modeloCategoria oModeloCategoria;
    frmProducto oFrmProducto;
    String Origen= "";
    
   
  
    public frmNewCategoriaJD1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
     public frmNewCategoriaJD1(java.awt.Frame parent, boolean modal, sesion pSesion, JInternalFrame frmOrigen) {
        super(parent, modal);
        initComponents();
        oSesion = pSesion;
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("REGISTRAR NUEVA CATEGORIA");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(resultado == true){
            ...
            if(Origen.equals("frmVehiculos")){
                oFrmVehiculo.cbxCategoria.setModel(oAbmCategoria.cargarCombo());
                this.dispose();
            }
            if(Origen.equals("frmProducto")){
                oFrmProducto.cbxCategoria.setModel(oAbmCategoria.cargarCombo());
                this.dispose();
            }
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNewCategoriaJD1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmNewCategoriaJD1 dialog = new frmNewCategoriaJD1(new javax.swing.JFrame(), true);
